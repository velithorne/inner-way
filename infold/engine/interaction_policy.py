...
CONTENT_OPERATORS = {"exact_repetition", "template_skeleton", "mutation_chain", "fold_echo", "symbol_table", "byte_fold"}
...
def get_ownership_scope(operator_id: str) -> str:
    ...
    if operator_id in CONTENT_OPERATORS:
        if operator_id in ("template_skeleton", "exact_repetition", "mutation_chain", "fold_echo"):
            return SCOPE_FAMILY
