...
CORRECTNESS_FIXTURES = [
    ...
    ("tests/fixtures/echo_friendly_config", "echo-friendly-config"),
    ("tests/fixtures/echo_friendly_handlers", "echo-friendly-handlers"),
    ("tests/fixtures/echo_friendly_txt", "echo-friendly-txt"),
